...
import { AlertTriangle, CalendarCheck2, CheckCircle2, Clock3, Globe2, Video } from "lucide-react";
...
export function AppointmentManagement({ initialAppointment }: AppointmentManagementProps) {
  ...
  return (
    <div className="bg-muted/20 py-16 sm:py-24"><div className="mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-8">
