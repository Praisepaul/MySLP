...
import { getGoogleCalendarConnection, saveGoogleCalendarConnection } from "@/lib/calendar/google-calendar-repository";
...
export async function getGoogleCalendarBusyIntervals(
  ...
  if (start >= end) {
    throw new Error("Google Calendar free/busy range must have a positive duration.");
  }
