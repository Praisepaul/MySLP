      ...
      <main className="flex-1">
        ...
        <section id="book" aria-labelledby="book-title" className="border-t py-20 sm:py-24">
          <div className="mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">Choose a session, find a suitable time and provide only the details needed to arrange your appointment.</p>
            <Link href="/book" className="mt-8 inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90">Start booking <ArrowRight aria-hidden="true" className="size-4" /></Link>
          </div>
        </section>
      </main>
      <PublicFooter />
